...
HP_tuning.py
```
this script requires you to create a wandb account an initialize a sweep # Description of our .py, .sh and .txt files
...
HP_tuning.py: this script requires you to create a wandb account an initialize a sweep <a href="https://docs.wandb.ai/guides/sweeps">sweep</a>. Once your agent is setup, please update accordingly the bash script run_hp.sh
...
. Once your agent is setup, please update accordingly the bash script run_hp.sh
