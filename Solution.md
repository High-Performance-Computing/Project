...
- Train using TensorFlow 2.0 (leveraging cuda and cudnn) and Elephas (https://github.com/maxpumperla/elephas) (PySpark module) in order to accelerate batch training 
